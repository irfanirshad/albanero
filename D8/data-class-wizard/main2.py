...
https://dataclass-wizard.readthedocs.io/en/latest/examples.html#a-more-complete-example
'''
...
class Person:
    ...
    hobbies: DefaultDict[str, List[str]] = field(default_factory=lambda: defaultdict(list))
