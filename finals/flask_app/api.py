...
def save_data():
    try:
        ...
        return jsonify({"Your input JSON has been successfully validated ... Here's a copy of it" : document}), 201
...
def save_data_new():
    try:
        ...
        return jsonify({"Your input JSON has been successfully validated ... Here's a copy of it" : user.model_dump()}), 201
